...
SDAROT_FULL_WATCH = 'https://www.sdarot.buzz/ajax/watch'
LOGIN = '/login'
USERNAME = 'Noa2022'
PASSWORD = 'Nohiedof16'
SEASON = 'season_'
...
SDAROT_FILE = r'C:\Users\cgc\Documents\Sdarot'
...
def login():
    ...
    headers = {
        ...
        "Accept": "*/*",
        "Referer": home.BASE_SDAROT_URL + '/'
    }
    session.post(home.BASE_SDAROT_URL + LOGIN, data=data, headers=headers)
...
def request_episode(token, sid, season, episode):
    ...
    cookie = {
        'Sdarot': sdarot_cookie}
    headers = {
        'authority': 'sdarot.buzz',
        'origin': home.BASE_SDAROT_URL,
        'referer': home.BASE_SDAROT_URL + '/',
    }
